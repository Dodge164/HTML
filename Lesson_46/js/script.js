...
// Ширина вместе с полосами прокрутки
const windowWidth = window.innerWidth;
console.log(windowWidth);

// Ширина полосы прокрутки
const skrollWidth = windowWidth - mainElementWidth;
console.log(skrollWidth);
...
// Получаем объект 1
const item1 = document.querySelector('h3');
...
// Получаем объект 3
const item3 = document.querySelector('.yellow');
// Получаем координаты относительно окна браузера
